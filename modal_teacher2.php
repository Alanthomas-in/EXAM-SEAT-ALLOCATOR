<div class="modal fade" id="teacher1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <select name="fname" class="span333">
	...
	<?php $teachers_query=mysqli_query($link,"select * from teachers WHERE teachid='".$_SESSION['teachid']."'")or die(mysqli_error($link));
...
<?php $sy_query=mysqli_query($link,"select * from sy")or die(mysqli_error($link));
