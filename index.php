...
a:hover {
  ...
  <div class="rounded" style="border: 2px double #036">
    ...
    <center><button id="myBtn" >Faculty Login</button></center>
  ...
  <div class="modal-content" style="width: 600px !important;">
    ...
    <form action="#" method="POST" style="background-color:white;">
     <center>
        ...
        <input name="username"  type="text" placeholder="User Name" style="margin-left:15px;margin-bottom:10px;width:200px" required="">
<br/>
...
<?php
                            ...
                            $password=$_POST['password'];
                             $result = mysqli_query($link,"SELECT * FROM login_details WHERE email_id ='$username' AND password = '$password' and usr_type='teacher'") or die(mysqli_error($link));
                                $numberOfRows = mysqli_num_rows($result);  
                                $result1 = mysqli_query( $link,"SELECT * FROM teachers WHERE  email ='$username'") or die(mysqli_error($link));
                                $row = mysqli_fetch_array($result1);
                                                                ...
                                                                if ($numberOfRows == 0) 
                                                                    ...
                                                                    $_SESSION['teachid'] = $row['teachid'];
                                                                        $_SESSION['user_type']="FACULTY";
                                                                        $_SESSION['UserFullName']= $row['fname'];
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <div class="contact-info">
                                <p><a href="https://goo.gl/maps/6AuprQYrxFXrEi4v9" target="_blank"><i class="fa fa-map-marker"></i></a>KE College</p>
