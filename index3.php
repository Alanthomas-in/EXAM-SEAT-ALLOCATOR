...
<?php
                            ...
                            $password=$_POST['password'];
                                ...
                                $result = mysqli_query($link,"SELECT * FROM login_details WHERE email_id ='$username' AND password = '$password' and usr_type='admin'") or die(mysqli_error($link));
                                ...
                                $numberOfRows = mysqli_num_rows($result);
                                                                ...
                                                                echo "<script language='javascript'>window.location.href='home3.php';</script>";
...
a:hover {
  background-color: yellow;
   ...
   <div class="rounded" style="border: 2px double #036">
    ...
    <center>
<center><button id="myBtn">Admin Login</button></center>
  ...
  <div class="modal-content" style="width: 600px !important;">
    ...
    <form action="#" method="POST" style="background-color:white;">
     <center>
        ...
        <Select name="username" style="margin-left:15px;margin-bottom:10px;width:200px">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <div class="contact-info">
                                <p><a href="https://goo.gl/maps/6AuprQYrxFXrEi4v9" target="_blank"><i class="fa fa-map-marker"></i></a>KE College Manannam</p>
